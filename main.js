...
// load the data
// d3.csv("datasets/mercancias_short.csv", function(error, data) {
  
//   //set up graph in same style as original example but empty
//   const graph = {"nodes" : [], "links" : []};

//   data.forEach(function (d) {
//     graph.nodes.push({ "name": d["Puerto Origen"] });
//     graph.nodes.push({ "name": d["Puerto Destino"] });
//     graph.links.push({ "source": d["Puerto Origen"],
//                        "target": d["Puerto Destino"],
//                        "value": +parseInt(d.Toneladas) });
//    });
